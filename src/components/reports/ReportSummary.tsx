  ...
  return (
    <div className="grid gap-4 grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 w-full max-w-full">
      ...
      <Card className="w-full max-w-full">
        ...
        <CardContent>
          <div className={`text-xl md:text-2xl font-bold ${saldo >= 0 ? 'text-green-600' : 'text-red-600'}`}>
      ...
      <Card className="w-full max-w-full">
        <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
          <CardTitle className="text-xs md:text-sm font-medium">Total de Transações</CardTitle>
